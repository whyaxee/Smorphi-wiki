...
4 | [Activity]<br />Your task now is to make the robot move forwards when it detects sound. You can implement your code in whatever way you like.<br /><br /> Once you are done, you can comapre your solution [here]() <br></br>
