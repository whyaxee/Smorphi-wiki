...
2 | [connecting your Pixycam to your Smorphi]<br /><br />For your Pixycam to be able to communicate to your Smorphi, we will have to set it up via the Serial I2C method. There are generally a few different methods of communications you can use <br /><br />https://docs.pixycam.com/wiki/doku.php?id=wiki:v2:porting_guide <br /><br />We setup the Pixy to use the I2C mode, we will need use the ribbon cable provided in the Pixycam package to connect our Pixycam to the master board. First, plug in the 10 pin female connector side to the pins on the Pixycam. Then, plug in the 6 pin female connector side to the pins on J13 port of the masterboard.<br /><br /> Refer to the assembly manual on how to connect the wires for the Pixycam.
